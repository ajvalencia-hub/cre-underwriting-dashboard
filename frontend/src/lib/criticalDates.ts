...
/** A row is only a date once it HAS a date (B11): the editor adds rows with
 *  an empty date while the user picks one — those never reach the chips,
 *  the pipeline strip, or the deal's stored inputs. */
