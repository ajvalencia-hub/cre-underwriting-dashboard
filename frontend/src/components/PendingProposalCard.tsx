 ...
 * App.tsx, which POSTs /api/agent/proposals/{id}/approve; the server merges
 * the change and records it in the deal's history (kind="agent"). */
export default function PendingProposalCard({
  ...
  return (
    <div className="rounded-md border border-indigo-200 bg-indigo-50/50 p-3 text-xs">
